...
namespace Compras.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "dept_id,dept_name,dept_status")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "dept_id,dept_name,dept_status")] Departments departments)
        {
            if (ModelState.IsValid)
            {
